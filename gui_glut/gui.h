...
class GUI {
    ...
    public:
        ...
        //-------------------clipping-------------------
        static void drawHalfSphere(float px, float py, float pz, float radius, bool inverted = false);
        static void drawSphereInsideBox222(float px, float py, float pz, float radius);
        //-------------------clipping-------------------

        static void drawSphere(float x, float y, float z, float radius, bool inverted = false);
